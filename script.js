// ======================================
//  HAPPY BIRTHDAY ANIMATION SCRIPT
//  Versi otomatis (tanpa popup SweetAlert)
// ======================================
...
window.addEventListener('load', () => {
    ...
    if (song) {
        song.volume = 0.5;
        song.play().catch(() => {
            console.warn("Autoplay diblokir browser, klik layar untuk mulai musik.");
            document.body.addEventListener("click", () => song.play(), { once: true });
        });
    }

    // Jalankan animasi utama
    animationTimeline();
});
